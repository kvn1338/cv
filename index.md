...
OSCP- and CRTO-certified IT Security Consultant and Penetration Tester specializing in offensive security, red teaming and custom tooling. Former software engineer with a strong background in web development, now focused on adversary simulation, complex enterprise environments and applications.
...
- **Tradecraft**: OPSEC, C2, payload development, defense evasion, reporting
...
- **Engineering**: Software development, custom tooling, automation, implant dev, reproducible environments  
...
`2021` **B.Sc. Computer Science**, *Humboldt University of Berlin*  
`2010` **Heinrich-Böll-Schule (bilingual secondary school)**, *Berlin* — Abitur
